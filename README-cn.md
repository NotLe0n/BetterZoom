...
如果你有任何问题请在论坛下方留言或加入我的<a href="https://discord.gg/NX4DVzz2v6">Discord</a></br>
本Mod在<a href="https://github.com/NotLe0n/BetterZoom">GitHub</a>上开源. 如果你有GitHub账户，请给我一个星标⭐！

相机控制部分已经移至另一个叫做<a href="https://steamcommunity.com/sharedfiles/filedetails/?id=2831018225">相机控制</a>的独立Mod </br>
如果你是个内容创造者，去看看吧！

<h1>如何使用:</h1>

<h2>设置部分:</h2>
点击滑块旁边的缩放或UI比例文本会把值重设为100%</br>
你可以使用「缩放」标题旁边的按钮切换滑块和准确数值输入模式</br>
只允许输入0-1000之间的一个数，按下Enter或其他键将提交更改</br>

<h3>缩放:</h3>
通过改变缩放滑块或按下[+]或[-]键（不是小键盘上的）来正常的缩小或放大游戏画面</br>
但是不仅限于把100%调成200%，你可以设置100%到1000%！</br>
...
你可以在游戏关闭后从[Documents/My Games/Terraria/tModLoader/config.json]中的配置文件修改</br>
...
禁用[Shift & +]/[Shift & -]两个更改UI比例的快捷键</br>

<h3>渲染更多物块 (默认: [启用]):</h3>
启用该选项以渲染更多超出视野范围内的物块</br>
注意：</br>
    这会使得你过分放大你的视野后造成游戏卡顿</br>
    我对此无能为力</br>

<h3>物块渲染限制 (默认: [1.0]):</h3>
这会设置在哪个缩放级别下可以看到更多的物块</br>
越低，游戏越卡，你能看到的物块越多</br>
（代码逻辑如此）</br>
例如，你设置了0.5（即50%）</br>
那么你只能看到视野范围内50%的物块</br>

<h3>缩放速度 (默认: [1.0])</h3>
修改使用快捷键更改缩放的速度，1为正常速度，10为10倍速
